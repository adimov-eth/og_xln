...
pub(crate) const ACCOUNT_SETTLED_TOPIC: [u8; 32] = [
    0x0f, 0x6f, 0xd0, 0x32, 0xd9, 0x13, 0xfe, 0xf8, 0xdb, 0xe7, 0xc7, 0xc5, 0x6a, 0x32, 0xbd, 0xf3,
    0xa1, 0xf7, 0xdf, 0xe4, 0x86, 0x63, 0xd4, 0xaf, 0x3f, 0x09, 0x74, 0xdc, 0xfc, 0xad, 0xfb, 0xdd,
];
...
pub enum JWatcherError {
    ...
    #[error("J_WATCHER_RETIRED_MONEY_ABI:address={address}:topic={topic}")]
    RetiredMoneyAbi { address: String, topic: String },
