...
} from '../j-submit/j-submit-scheduler';
import {
...
export type RuntimeWakeDeps = {
  ...
  getRuntimeNowMs(env: RuntimeReplica): number;
};
...
export const hasDueEntityHooksWithDeps = (env: RuntimeReplica, deps: RuntimeWakeDeps): boolean => {
