 ...
 *
 * Usage:
 *   bun core/api/server/index.ts                    # Server on :8080
 *   bun core/api/server/index.ts --port 9000        # Custom port
 */
...
export async function startXlnServer(opts: Partial<XlnServerOptions> = {}): Promise<void> {
  ...
  try {
    ...
    if (SKIP_SERVER_BOOTSTRAP) {
      ...
      throw new Error('SHARED_HUB_BOOTSTRAP_REMOVED: use core/orchestrator/orchestrator.ts');
    }
