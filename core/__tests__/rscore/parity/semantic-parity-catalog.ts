...
const CROSS_J_ENTITY_KINDS_EVIDENCE = [
  'rscore/fixtures/cross-j-entity-kinds/generate.ts',
  'rscore/crates/entity-kernel/src/cross_j/group_d_parity.rs',
  'rscore/fixtures/cross-j-entity-kinds/group-d-v1.json',
] as const;
...
export const ENTITY_TX_SEMANTIC_CATALOG = [
  ...
  coveredEntity('crossJurisdictionBookOrderRemoved', 'core/entity/tx/handlers/cross-j/book-order.ts', CROSS_J_ENTITY_KINDS_EVIDENCE),
  coveredEntity('crossJurisdictionFillNotice', 'core/entity/tx/handlers/cross-j/fill.ts', CROSS_J_ENTITY_KINDS_EVIDENCE),
  coveredEntity('crossJurisdictionForceSiblingDispute', 'core/entity/tx/handlers/cross-j/force-sibling-dispute.ts', CROSS_J_ENTITY_KINDS_EVIDENCE),
  coveredEntity('crossJurisdictionSalvage', 'core/entity/tx/handlers/cross-j/salvage.ts', CROSS_J_ENTITY_KINDS_EVIDENCE),
  ...
  coveredEntity('orderbookSweepCrossJurisdiction', 'core/entity/tx/handlers/cross-j/sweep.ts', CROSS_J_ENTITY_KINDS_EVIDENCE),
  coveredEntity('placeSwapOffer', 'core/entity/tx/handlers/payments/swap-requests.ts', ENTITY_SAME_J_FINANCIAL_EVIDENCE),
  coveredEntity('prepareCrossJurisdictionSwap', 'core/entity/tx/handlers/cross-j/setup.ts', CROSS_J_ENTITY_KINDS_EVIDENCE),
  ...
  coveredEntity('removeCrossJurisdictionBookOrder', 'core/entity/tx/handlers/cross-j/book-order.ts', CROSS_J_ENTITY_KINDS_EVIDENCE),
  coveredEntity('requestCollateral', 'core/entity/tx/handlers/account/lifecycle/admin.ts', ENTITY_SAME_J_FINANCIAL_EVIDENCE),
  coveredEntity('requestCrossJurisdictionClear', 'core/entity/tx/handlers/cross-j/clear.ts', CROSS_J_ENTITY_KINDS_EVIDENCE),
  coveredEntity('materializeCrossJurisdictionClear', 'core/entity/tx/handlers/cross-j/clear.ts', CROSS_J_ENTITY_KINDS_EVIDENCE),
