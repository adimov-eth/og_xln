...
describe('WebSocket trusted decode boundary', () => {
  test('pins every canonical envelope variant to an independent golden hash', () => {
    const variants = {
      ...
      delivery_ready: { type: 'delivery_ready', id: 'ready-1', from: 'a', to: 'b', payload: true },
    ...
    const expected = {
      ...
      delivery_ready: '0x6b45f3decf5bec9fb8852354bc6f536936ac7a21811e952f9f69616c7ee778bb',
