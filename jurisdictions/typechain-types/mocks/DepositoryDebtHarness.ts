...
export interface DepositoryDebtHarnessInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
  ...
  encodeFunctionData(
    functionFragment: "harnessAddDebt",
    values: [BytesLike, BigNumberish, BytesLike, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "harnessAddWideDebt",
    values: [BytesLike, BigNumberish, BytesLike, Uint512Struct]
  ): string;
  encodeFunctionData(
    functionFragment: "harnessForgiveCurrent",
...
export namespace DebtForgivenEvent {
  ...
  export type OutputTuple = [
    ...
    creditor: string,
    tokenId: bigint,
    amountForgiven: Uint512StructOutput,
    debtIndex: bigint
  ];
  export interface OutputObject {
    debtor: string;
...
export interface DepositoryDebtHarness extends BaseContract {
  connect(runner?: ContractRunner | null): DepositoryDebtHarness;
  waitForDeployment(): Promise<this>;

  interface: DepositoryDebtHarnessInterface;
  ...
  debtOutstanding: TypedContractMethod<
    [arg0: BytesLike, arg1: BigNumberish],
    [[bigint, bigint, bigint] & { high: bigint; middle: bigint; low: bigint }],
    "view"
  >;
  ...
  harnessAddDebt: TypedContractMethod<
    [
      debtor: BytesLike,
      tokenId: BigNumberish,
      creditor: BytesLike,
  ...
  harnessAddWideDebt: TypedContractMethod<
    [
      debtor: BytesLike,
      tokenId: BigNumberish,
      creditor: BytesLike,
  ...
  getFunction(
    nameOrSignature: "harnessAddDebt"
  ): TypedContractMethod<
    [
      debtor: BytesLike,
      tokenId: BigNumberish,
  ...
  >;
  getFunction(
    nameOrSignature: "harnessAddWideDebt"
  ): TypedContractMethod<
    [
      debtor: BytesLike,
      tokenId: BigNumberish,
  ...
  filters: {
    ...
    "DebtForgiven(bytes32,bytes32,uint256,tuple,uint256)": TypedContractEvent<
      DebtForgivenEvent.InputTuple,
      DebtForgivenEvent.OutputTuple,
      DebtForgivenEvent.OutputObject
    >;
