...
export type JurisdictionConfig = {
  /** og JurisdictionConfig.name: the J replica an Entity's J outputs go to, also read by og's cross-j binding message; never committed (og projectConsensusConfigCommitment). */
